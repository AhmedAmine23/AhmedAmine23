...
<img src="https://komarev.com/ghpvc/?username=AhmedAmine23&label=Profile%20views&color=1F3A5F&style=flat" />
...
<img src="https://skillicons.dev/icons?i=c,arduino,raspberrypi,git,github&theme=dark" /><br/>
...
**Protocols:** SPI · I²C · UART · MQTT · TCP/IP
...
|---|---|---|
| **[TRAXX Car — Sensor Hub Migration](https://github.com/AhmedAmine23/REPO-NAME)** | Migrated an 8-sensor ultrasonic hub from Arduino to STM32 + FreeRTOS, streaming data to a Jetson Nano over SPI/DMA | `STM32` `FreeRTOS` `SPI/DMA` |
| **[11-Stage Ring Oscillator w/ Enable](https://github.com/AhmedAmine23/REPO-NAME)** | Enable-gated ring oscillator driving a tapered buffer, designed and simulated in Cadence | `Cadence` `VLSI` |
| **[Two-Stage CMOS Op-Amp](https://github.com/AhmedAmine23/REPO-NAME)** | Two-stage CMOS operational amplifier, sized and compensated for target gain/bandwidth/phase margin | `Cadence` `Analog IC` |
| **[Environmental Monitoring System](https://github.com/AhmedAmine23/REPO-NAME)** | ESP32 → MySQL → web dashboard supervision system with WhatsApp/buzzer alerts | `ESP32` `MySQL` `PHP/JS` |
